  ...
  return (
    <div className="container" style={{ padding: '8rem 2rem' }}>
      <div className="card shadow-soft" style={{ maxWidth: '1000px', margin: '0 auto', padding: '4rem', background: 'white', borderRadius: '32px' }}>
        ...
        <h1 style={{ fontSize: '3.5rem', fontWeight: 900, marginBottom: '2rem', letterSpacing: '-0.04em' }}>Terms and Conditions</h1>
        ...
        <section style={{ marginBottom: '3rem' }}>
          <h2 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '1.5rem', borderLeft: '4px solid var(--primary-color)', paddingLeft: '1.5rem' }}>2. Eligibility and User Responsibilities</h2>
          <p style={{ color: 'var(--text-secondary)', lineHeight: '1.8' }}>
        ...
        <section style={{ marginBottom: '3rem', border: '2px solid rgba(239, 68, 68, 0.1)', padding: '2rem', borderRadius: '24px', background: 'rgba(239, 68, 68, 0.02)' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '1rem', color: '#dc2626' }}>3. Financial Advice Disclaimer</h2>
        ...
        <section style={{ marginBottom: '3rem' }}>
          <h2 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '1.5rem', borderLeft: '4px solid var(--primary-color)', paddingLeft: '1.5rem' }}>6. Limitation of Liability</h2>
          <p style={{ color: 'var(--text-secondary)', lineHeight: '1.8' }}>
