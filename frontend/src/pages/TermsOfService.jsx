        ...
        <div style={{ color: 'var(--text-secondary)', lineHeight: '1.9', fontSize: '1.05rem' }}>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              Welcome to SmartTracker. These Terms & Conditions constitute a legally binding agreement between you and SmartTracker regarding your use of our application, website, and related financial tracking services. By accessing, browsing, or using any part of the service, you acknowledge that you have read, understood, and agree to be bound by these terms.
            </p>
            <p>
              If you are using the service on behalf of an entity, you represent and warrant that you have the authority to bind that entity to these terms. If you do not agree with any part of these Terms & Conditions, you must immediately cease all use of the SmartTracker platform.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              To access the full features of SmartTracker, you must create a secure account. You agree to provide accurate, current, and complete information during the registration process. You are solely responsible for maintaining the confidentiality of your account credentials, including your email and password, and for all activities that occur under your account.
            </p>
            <p>
              By registering for an account, you represent that you are at least 18 years of age or the legal age of majority in your jurisdiction. SmartTracker reserves the right to suspend or terminate accounts that provide false information or otherwise violate the spirit of these terms.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              You agree to use SmartTracker only for lawful purposes and in a manner that does not infringe the rights of, or restrict the use and enjoyment of this platform by, any third party. Prohibited activities include, but are not limited to:
            </p>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
              ...
              <li style={{ marginBottom: '0.75rem' }}>Harassing, threatening, or otherwise violating the legal rights of SmartTracker employees or other users.</li>
              <li style={{ marginBottom: '0.75rem' }}>Reverse engineering, decompiling, or attempting to derive the source code of the underlying SmartTracker engine.</li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              SmartTracker provides a framework for financial tracking, but the accuracy of all reports, charts, and balances is directly dependent on the data you provide. We do not provide automated bank synchronization; therefore, all information is user-generated and should be treated accordingly.
            </p>
            <p style={{ marginBottom: '1.5rem' }}>
              While we use advanced mathematical algorithms to process your data, we do not warrant that the service will be 100% error-free. You should never rely solely on SmartTracker for critical financial decisions, legal reporting, or tax filings unless you have cross-verified the data with official source documents (e.g., bank statements, receipts).
            </p>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              All software, design (UI/UX), graphics, logos, and content created by SmartTracker are the exclusive property of SmartTracker or its licensors. These materials are protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SMARTTRACKER AND ITS EMPLOYEES, AFFILIATES, AND LICENSORS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, OR USE, REGARDLESS OF WHETHER WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
            </p>
            <p>
              In no event shall our total liability for all claims arising out of or relating to the service exceed the total amount of fees paid by you to SmartTracker in the twelve months preceding the event giving rise to the claim (or $50 if the service was provided free of charge).
            </p>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              SmartTracker evolves over time, and so do our Terms & Conditions. We reserve the right to modify these terms at any time. When we make changes, we will update the "Effective Date" at the top of this page. We encourage you to review these terms periodically to stay informed.
            </p>
            <p>
