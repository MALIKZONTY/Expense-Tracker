      ...
      <div className="card" style={{ padding: 'clamp(2rem, 5vw, 4rem) clamp(1.5rem, 4vw, 3rem)' }}>
        ...
        <div style={{ color: 'var(--text-secondary)', lineHeight: '1.9', fontSize: '1.05rem' }}>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              Our platform may contain links to third-party websites or services that are not owned or controlled by SmartTracker. We have no control over the content, privacy policies, or practices of any third-party sites or services and assume no responsibility for them. The inclusion of any link does not imply endorsement by SmartTracker of the site.
            </p>
            <p>
              You acknowledge and agree that SmartTracker shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods, or services available on or through any such web sites or services.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              Under no circumstances shall SmartTracker, its directors, employees, or developers be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising out of your access to, use of, or inability to use the service. This includes, without limitation, damages for loss of profits, data, goodwill, or other intangible losses.
            </p>
            <p>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              By using SmartTracker, you voluntarily assume all risks associated with the use of digital financial management tools, including the risk of data loss, technical interruption, or mathematical error in user-generated reports. You are encouraged to maintain independent backups of your critical financial records.
            </p>
          </section>
